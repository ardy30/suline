...
import boeren.com.appsuline.app.bmedical.appsuline.constant.PCLinkLibraryDemoEnum.LeavePageState;
import boeren.com.appsuline.app.bmedical.appsuline.fragments.FullScreenDialogFragmentBase;
import boeren.com.appsuline.app.bmedical.appsuline.views.AEditText;
...
public class MeterPreferenceDialog extends FullScreenDialogFragmentBase implements OnSearchBLEClickListener {
    ...
    private void showSearchMeterDialog() {
        ...
        if (!mSearchMeterDialog.isShowing()) {
    ...
    private class LeAcceptThread extends Thread {
        ...
        /**
         * Constructor. Prepares a new {@link android.bluetooth.BluetoothServerSocket}.
         */
